...
public class Client
{
	...
	{
		return JOptionPane.showInputDialog(game.getFrame(), "Enter The IP Address Of The Server:", "Welcome To The Chatter",
				JOptionPane.QUESTION_MESSAGE);
	}

	/**
	 * a Prompt for and return the desired screen name.
	 */
	private String getName()
	{
		return JOptionPane.showInputDialog(game.getFrame(), "Choose A Screen Name:", "Screen Name Selection",
